...
export const WorkExperienceItem: React.FC<WorkExperienceInterface> = ({brand, period, details}) => {
    return (
        <div className="relative w-full">
            ...
            <div className="ml-6">
                ...
                <span className="mt-1 block text-sm font-semibold text-gray-500">{period}</span>
            </div>
        </div>
    )
}